...
public class CardDaoImpl implements CardDao {
    ...
    public void save(Card card) {
        ...
        emUtil.performWithinTx(entityManager -> {
            if (entityManager.getEntityManagerFactory().getPersistenceUnitUtil().getIdentifier(card.getPerson()) != null) {
                Person managedPerson = entityManager.merge(card.getPerson());
